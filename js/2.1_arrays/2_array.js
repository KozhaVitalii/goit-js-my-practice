...
// Цикл for - используется когда намнеобходимо достучаться до индекса массива и мы планируем изменять 
// элементы массива
// Цикл for of - используется если нам просто необходимо перебрать массив (при этом нам не нужен индекс 
// или что-то поменять в массиве)