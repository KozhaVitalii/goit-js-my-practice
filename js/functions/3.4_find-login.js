...
// Ещё с такой стороны распишу: у нас есть function (allLogins, loginToFind), где
//     allLogins, - это наш параметр
//     loginToFind - это наш аргумент
// а, это вызов функции console.log(findLogin(logins, 'avocod3r'));
...
// а при вызове указываем findLogin(1,2), где один это параметр, т.е. переменная(массив), а 2 это аргумент (критерий)   
...
// Решим задачку двумя способами, через for, а затем через "инклудс и тернарный оператор"
